...
export default tseslint.config(
  ...
  // TypeScript ESLint recommended rules (untyped)
  tseslint.configs.recommended,

  // TypeScript ESLint recommended rules (type-checked)
  tseslint.configs.recommendedTypeChecked,

  // TypeScript ESLint stylistic rules (type-checked)
  ...
  // TypeScript and TSX files configuration
  {
    ...
    rules: {
      // TypeScript specific rules - using only rules that definitely exist
